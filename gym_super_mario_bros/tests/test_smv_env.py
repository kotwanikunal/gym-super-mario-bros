...
class ShouldRaiseErrorOnInvalidRomMode(TestCase):
    def test(self):
        self.assertRaises(ValueError, AdventureIslandEnv, rom_mode=-1)
        self.assertRaises(ValueError, AdventureIslandEnv, rom_mode=5)
        self.assertRaises(ValueError, AdventureIslandEnv, rom_mode=-1, lost_levels=True)
        self.assertRaises(ValueError, AdventureIslandEnv, rom_mode=5, lost_levels=True)


class ShouldRaiseErrorOnInvalidTypeLostLevels(TestCase):
    def test(self):
        self.assertRaises(TypeError, AdventureIslandEnv, lost_levels='foo')


class ShouldRaiseErrorOnInvalidTypeWorld(TestCase):
    def test(self):
        self.assertRaises(TypeError, AdventureIslandEnv, target=('foo', 1))


class ShouldRaiseErrorOnBelowBoundsWorld(TestCase):
    def test(self):
        self.assertRaises(ValueError, AdventureIslandEnv, target=(0, 1))
        self.assertRaises(ValueError, AdventureIslandEnv, target=(0, 1), lost_levels=True)


class ShouldRaiseErrorOnAboveBoundsWorld(TestCase):
    def test(self):
        self.assertRaises(ValueError, AdventureIslandEnv, target=(9, 1))
        self.assertRaises(ValueError, AdventureIslandEnv, target=(13, 1), lost_levels=True)
...
class ShouldRaiseErrorOnBelowBoundsStage(TestCase):
    def test(self):
        self.assertRaises(ValueError, AdventureIslandEnv, target=(1, 0))
        self.assertRaises(ValueError, AdventureIslandEnv, target=(1, 0), lost_levels=True)


class ShouldRaiseErrorOnAboveBoundsStage(TestCase):
    def test(self):
        self.assertRaises(ValueError, AdventureIslandEnv, target=(1, 5))
        self.assertRaises(ValueError, AdventureIslandEnv, target=(1, 5), lost_levels=True)
...
class ShouldStepStageEnv(TestCase):
    def test(self):
        env = AdventureIslandEnv(target=(4, 2))
