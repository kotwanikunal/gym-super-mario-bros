...
def _register_adventure_island_env(id, is_random=False, **kwargs):
    """
    Register an Adventure Island. (1/2) environment with OpenAI Gym.
...
# Adventure Island.
_register_adventure_island_env('AdventureIsland-v0', rom_mode='vanilla' )


# def _register_mario_stage_env(id, **kwargs):
#     """
#     Register Adventure Island (1/2) stage environment with OpenAI Gym.
#
#     Args:
#         id (str): id for the env to register
#         kwargs (dict): keyword arguments for the SuperMarioBrosEnv initializer
...
# _ID_TEMPLATE = 'AdventureIsland{}-v{}'
...
#         env_id = _ID_TEMPLATE.format('', stage, version)
